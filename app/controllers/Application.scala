  ...
  def javascriptRoutes = Action { implicit request =>
    Ok(
      Routes.javascriptRouter("jsRoutes")(
        ...
        api.routes.javascript.Metadata.getDefinitionsAutocompleteName,
        api.routes.javascript.Metadata.getManagedTermsAutocompleteName,
        ...
        api.routes.javascript.Metadata.makeDefinitionAddable,
        api.routes.javascript.Metadata.removeMetadata,
        api.routes.javascript.Metadata.removeMetadataById,
