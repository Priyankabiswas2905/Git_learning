  ...
  def javascriptRoutes = Action { implicit request =>
    Ok(
      Routes.javascriptRouter("jsRoutes")(
        ...
        api.routes.javascript.Metadata.getDefinitionsAndPromotedMetadataFields,
        api.routes.javascript.Metadata.addPromotedMetadataField,
        api.routes.javascript.Metadata.deletePromotedMetadataField,
        api.routes.javascript.Metadata.getPromotedMetadataFields,
        api.routes.javascript.Metadata.editPromotedMetadataField,
