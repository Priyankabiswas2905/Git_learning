...
object SearchUtils {
  lazy val files: FileService = DI.injector.instanceOf(classOf[FileService])
  lazy val datasets: DatasetService = DI.injector.instanceOf(classOf[DatasetService])
  lazy val folders: FolderService = DI.injector.instanceOf(classOf[FolderService])
  lazy val collections: CollectionService = DI.injector.instanceOf(classOf[CollectionService])
  lazy val metadatas: MetadataService = DI.injector.instanceOf(classOf[MetadataService])
  lazy val comments: CommentService = DI.injector.instanceOf(classOf[CommentService])
